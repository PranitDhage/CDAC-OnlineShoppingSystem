...
import { COMPANY_UPDATE_RESET, COMPANY_UPDATE_SUCCESS } from '../../constants/productConstants'
...
const UpdateCompanyScreen = (props) => {
  ...
  useEffect(async() => {
    if (response && response.status == 'OK') {
      await dispatch({ type: COMPANY_UPDATE_RESET })
      await props.history.push('/show-company')
    } else if (error) {
